  ...
  return (
    <div className={`${style.card}`}>
      ...
      <div className={`${style.details}`}>
        ...
        <p style={{ cursor: 'pointer', display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
      ...
      <section className={`${style.sectioninfodivoutersec}`}>
        <div className={`${style.infodivouter}`}>
          <p style={{ display: "grid", gap: "10px" }}>
            Hello! Hope You have a good day. Earning from the crypto mining is not an easy task nowadays. So be cautious before planning to do it. If you are not that familiar with this mining stuff I recommend you to go through this article once.
